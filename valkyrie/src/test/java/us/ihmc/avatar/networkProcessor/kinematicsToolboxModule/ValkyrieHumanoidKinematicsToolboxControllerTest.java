...
public class ValkyrieHumanoidKinematicsToolboxControllerTest extends HumanoidKinematicsToolboxControllerTest
{
   ...
   protected HumanoidKinematicsToolboxControllerTest.MultiContactConstraintData createMultiContactConstraintData()
   {
      ...
      contactConstraintData.handPoses.get(RobotSide.LEFT).getPosition().set(0.7, 0.4, 0.25);
      contactConstraintData.handPoses.get(RobotSide.RIGHT).getPosition().set(0.5, -0.45, -0.05);
      ...
      contactConstraintData.handPoses.get(RobotSide.LEFT).getOrientation().setYawPitchRoll(0.0, Math.toRadians(-50.0), -Math.toRadians(10.0));
      contactConstraintData.handPoses.get(RobotSide.RIGHT).getOrientation().setYawPitchRoll(0.0, Math.toRadians(-50.0), Math.toRadians(10.0));
      ...
      contactConstraintData.nominalCenterOfMass.setToZero();
